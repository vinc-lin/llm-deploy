...
It also prints a **per-element ratio** (median, p05, p95) and says whether the
error is **uniform** across elements. That distinction matters: a uniform factor
points at a scaling/duplication at the seam, a non-uniform one points at
saturation, layout, or something structural.
